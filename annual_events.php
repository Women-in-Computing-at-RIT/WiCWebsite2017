        ...
        <div class="container">
            <div class="row">
                <section class="category-content col-sm-9">
                    ...
                    <ul class="media-list">
                        ...
                        <li class="media">
                            ...
                            <div class="media-body">
                                ...
                                <p>Blogs: <a href="/post.php?id=5">2018</a>, <a href="/post.php?id=20">2019</a></p>
                            </div>
                        </li>
                        <hr/>
                        <li class="media">
                            <div class="media-left">
                                <img class="media-object" src="img/annualevents/wicconnects.jpg" alt="Picture of WiConnects">
                            </div>
                            <div class="media-body">
                    ...
                    <h2 class="category-title" id="conferences">CONFERENCES</h2>
                    <ul class="media-list">
                        <li class="media">
                            <div class="media-left">
                                <img class="media-object" src="img/annualevents/NYCWIC.jpg" alt="Picture of NYCWiC">
                            </div>
                            <div class="media-body">
