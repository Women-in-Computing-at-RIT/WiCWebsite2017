            ...
            <div class="row">
                <!--<section class="page col-sm-9">-->
                    ...
                    <div class="entry">
                        ...
                        <p>With hacking stories appearing daily in global news headlines, and a world that's more
                            interconnected than ever, we need sharp minds focused on safeguarding online communities
                            and capabilities. Girls will love this all-girls hands-on camp that emphasizes cyber ethics,
                            online safety, cyber security and defense.</p>
                        ...
                        <p>For acceptance, each student needs to:</p>
                            <ol>
                        ...
                        <div style = "margin-top:3%">
                            <div style = "float:left; width:50%; margin-top:10%">
                                ...
                                <h3>COST: FREE</h3><br>
                                <h4>Sign up to be contacted when applications are available.<br><br>
                                <a href = "http://bit.ly/2019GenCyberGirlCamp">http://bit.ly/2019GenCyberGirlCamp</a>
                                </h4>
                            </div>
