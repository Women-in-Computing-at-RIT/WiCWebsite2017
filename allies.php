                ...
                <section class="page col-sm-9">
                    ...
                    <div class="entry">
                        ...
                        <div class="row-alliespics">
                            <img class="alliespics" src="img/allies/allies_larger2.jpg" alt="Allies Members"/>
                            <img class="alliespics" src="img/allies/allies_logo_larger2.png" alt="Allies Logo"/>
                        </div>
                    </div>
                    
                    <br><br>
                    
                    <h2 class="page-title" id="howtoallytitle">HOW TO BE AN ALLY</h2>
