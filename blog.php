        ...
        <div class="row">
            ...
            <aside class="sidebar col-sm-3">
                <div class="widget">
                    <h4>ARCHIVE</h4>
                    <ul id="archive">
                        <li class="current" onclick="getPosts('Spring 2019'); makeCurrent(this);"><a href="javascript:;" title="">Spring 2019</a></li>
...
<script>
    ...
    window.onload = getPosts("Spring 2019"); //CHANGE THIS EVERY SEMESTER
