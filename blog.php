        ...
        <div class="row">
            ...
            <aside class="sidebar col-sm-3">
                <div class="widget">
                    <h4>ARCHIVE</h4>
                    <ul id="archive">
                        <li class="current" onclick="getPosts('Fall 2018'); makeCurrent(this);"><a href="javascript:;" title="">Fall 2018</a></li>
...
<script>
    ...
    window.onload = getPosts("Fall 2018"); //CHANGE THIS EVERY SEMESTER
